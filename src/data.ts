    ...
    customizations: [
      {
        ...
        options: [
          ...
          { name: 'hh Red Fiery (Sichuan Style)', price: 0 },
        ]
      }
    ]
  },
...
export const MOKAI_GALLERY_SPACES = [
  {
    ...
    spots: [
      { x: 25, y: 35, title: 'Experience hh Wall', txt: 'Curated signage detailing Mokai’s journey from a humble local dream to a mumbai coffee sanctuary.' },
